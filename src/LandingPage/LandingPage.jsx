    ...
    <div id="LandingPage_Container" >
      <section id="LandingPageSection1" onScroll={() => handleScroll()}>
        <div id="LandingPage_IntroductoryText">
          ...
          <h4 id="LandingPage_StockMarketSimplified">The stock market simplified</h4>
        </div>
      ...
      <section id="LandingPageSection3">
        <div id="LandingPage_NewHeights" className="LandingPage-rightText">
          ...
          <h5>Take advantage of OMEGA's assistance to simplify complicated stock information into clearer conclusions</h5>
        </div>
      </section>
      ...
      <section id="LandingPageSection4">
        <div id="LandingPage_GrowMoney" className="LandingPage-leftText">
          ...
          <h5>OMEGA's vast data collection means you have more choice in deciding what stocks will benefit you and your money.</h5>
        </div>
      </section>
