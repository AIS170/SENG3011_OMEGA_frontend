import { getUsername, getUsersActualName } from "../getUserDetails";
...
const ANALYSIS_ENDPOINT = "http://analytics-load-balancer-2055996024.ap-southeast-2.elb.amazonaws.com"
  ...
  return (
    ...
    <div className=" min-h-screen bg-black">
      <div className="flex items-center justify-center flex-wrap">
        <div className="text-center w-[100%] font-semibold text-[50px] mt-[4%] text-white">Analyse a Company Stock</div>
        <div className="p-[4%]">
          <div className="typewriter text-white">Enter a company to analyse their stocks.</div>

          <form onSubmit={(e) => analyseStockName(e)} className="border-3 border-white mt-[8%] rounded-sm p-[8%]">
            <input placeholder="Company name" className="bg-white rounded-sm p-[8px] border-2 border-gray-400 unselectable focus:border-orange-400" type="text" />
            <br/>
            <button
                    type="submit"
      ...
      {error && <div className="text-center text-red-600 bg-white p-[2%]">Ensure you have provided a valid company name. If the problem persists, contact us through the <a href="/ai-help" className="underline text-blue-400">help</a> page.</div>}
